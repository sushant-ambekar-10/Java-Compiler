	...
	Main.addWindowListener(new WindowAdapter()
			{
                public void windowClosing(WindowEvent e){
                    ...
                    int i=JOptionPane.showConfirmDialog(f, "you want to save this file ?","Save or not",JOptionPane.YES_NO_OPTION,JOptionPane.QUESTION_MESSAGE);     //created by Sushant Ambekar 
